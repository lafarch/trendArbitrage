...
class TrendArbitrageEngine:
    ...
    def __init__(self, config_path: str = "config/config.yaml"):
        ...
        self.scraper = MarketplaceScraper(
            # Antes 3
            delay=scraping_config.get("delay_between_requests", 50),
        ...
        """self.analyzer = OpportunityAnalyzer(
            min_interest=1, max_supply=5000  # Antes 20  # Antes 500
        )"""
    ...
    def run_pipeline(
        ...
        for keyword in trend_df["keyword"]:
            ...
            supply_metrics = self.scraper.get_supply_metrics(
                keyword, platforms=["ebay", "amazon"]  # Can add 'amazon' if needed
            )
